 ...
 */
public class B_CrumblingWall2 extends Util implements Obstacle {

    private final int crumblingWall = 1948;
    private final Tile wallTile = new Tile(2542, 3553, 0);
    private final Area wallArea = new Area(new Tile(2538, 3552, 0), new Tile(2542, 3554, 0));
